...
class StudentClass:
    def __init__(self,root):
        ...
        self.root.geometry("1200x500+80+100")
        ...
        lbl_city=Label(self.root,text="City",font=("goudy old style",15,'bold'),bg='white').place(x=10,y=220)
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=150,y=220,width=160)

        lbl_pin=Label(self.root,text="PIN",font=("goudy old style",15,'bold'),bg='white').place(x=390,y=220)
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=480,y=220,width=120)
        ...
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15,'bold'),bg='white').place(x=380,y=60)
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15,'bold'),bg='white').place(x=380,y=100)
        lbl_admission=Label(self.root,text="Admission",font=("goudy old style",15,'bold'),bg='white').place(x=380,y=140)
        lbl_course=Label(self.root,text="Course",font=("goudy old style",15,'bold'),bg='white').place(x=380,y=180)
        ...
        self.CourseTable=ttk.Treeview(self.C_Frame,columns=("roll","name","email","gender","dob","contact","admission","course","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row!=None:
                    ...
                    cur.execute("insert into student (roll,name,email,gender,dob,contact,admission,course,city,pin,address) values(?,?,?,?,?,?,?,?,?,?,?)",(
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row==None:
                    ...
                    cur.execute("update student set name=?,email=?,gender=?,dob=?,contact=?,admission=?,course=?,city=?,pin=?,address=? where roll=?",(
                        self.var_name.get(),
                        self.var_email.get(),
                        self.var_gender.get(),
                        self.var_dob.get(),
